...
class Thief:
    ...
    def __init__(self):
        self.config = Config.get_conf(self, identifier=91928524318855168, force_registration=True)
        default_guild = {
            "Config": {
                "Start": False,
                "Planned": False,
    ...
    async def requirement_check(self, prefix, author, cost):
        ...
        crew = await self.get_guild_crew(author.guild)
